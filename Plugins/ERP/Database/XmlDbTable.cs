...
namespace ErpServices.Database
{
	public class XmlDbTable : IDbTable
	{
		...
		{
			Filename = Path.GetFileNameWithoutExtension(xmlFile.FullName);
		...
		public virtual void Initialize()
		{
			...
			Name = DataSet.Tables[0].TableName;
	...
	{
		public NewXmlDbTable(IFileInfo xmlFile, string name) : base(xmlFile)
		{
			Name = name;
		}
