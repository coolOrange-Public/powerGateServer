...
namespace VaultServices
{
	...
	public class VaultService : ContainerBasedService
	{
		...
		private readonly Configuration _configuration = GetConfiguration();
		...
		public VaultService()
		{
			...
			ContainerBuilder.RegisterModule<coolOrange.Powershell.Cmdlets.Startup.Modules.VaultModule>();
			ContainerBuilder.RegisterInstance(connection.GetServices()).As<IVaultServices>();
